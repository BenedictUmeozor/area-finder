      ...
      <main>
        <Container className="h-full max-md:grid max-md:place-items-center flex items-center justify-center gap-[7.5%]">
          <div className="flex-1">
            <h1 className="font-bold max-md:text-5xl text-6xl mb-8">
            ...
            <div className="relative h-12 mb-4">
              <input
                ...
                className="h-full w-full focus:outline-none bg-lightest_bg dark:bg-darkest_bg  border rounded border-last_light_bg dark:border-darker_bg pl-[7%] pr-2"
              />
